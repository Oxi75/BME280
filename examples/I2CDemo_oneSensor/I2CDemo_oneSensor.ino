...
const uint8_t I2C_Addr{0x76};         //I2C default Address 
//const uint8_t I2C_Addr{0x77};         //I2C alternative Address 
...
void setup() {
  ...
  while (!BME280.begin_I2C(I2C_Addr, I2C_FAST_MODE_PLUS_MODE))  // Start BME280 using I2C protocol on defined bus address
  {
